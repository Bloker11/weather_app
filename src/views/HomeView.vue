  ...
  <main class="container text-white">
    <div class="pt-4 mb-8 relative">
      <input
        ...
        class="py-2 bg-transparent w-full border-b focus:cursor-pointer focus:bg-weather-secondary focus:shadow-[0px_1px_0_0_#004E71] focus:outline-none"
      ...
      <ul class="absolute bg-weather-secondary text-white w-full shadow-md py-2 px-1 top-[66px]" v-if="mapboxSearchResults">
        ...
        <p v-if="!searchError && mapboxSearchResults.length === 0">Sorry, no result has mached your input. Please continue with another input.</p>
